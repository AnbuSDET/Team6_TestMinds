Feature: Addnew Programpage
  ...
  Scenario Outline: Verify enter description
    ...
    Examples: 
      | sheetName | ScenarioName            |
      | program   | Enter valid description |
  ...
  Scenario Outline: Verify select Status
    ...
    Examples: 
      ...
      | program   | Verify select Status | Active |
  ...
  Scenario Outline: Verify Admin is able to save the program details
    ...
    Then Admin gets message '<message>' from "<sheetName>" with scenario name "<scenarioName>"

    Examples: 
      | sheetName | ScenarioName                 | message                    |
      | program   | Save program with valid data | Successful Program created |
